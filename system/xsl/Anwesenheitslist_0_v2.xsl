...
<office:document-content
	...
	<office:body>
		<office:text text:use-soft-page-breaks="true" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0">
			...
			<draw:frame draw:style-name="fr1" draw:name="Picture 3" text:anchor-type="page" text:anchor-page-number="1" svg:x="16.475cm" svg:y="1.274cm" svg:width="2.999cm" svg:height="2.999cm" draw:z-index="0"><draw:image xlink:href="Pictures/10000000000001F4000001F4E7EF10DB.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
			</draw:frame>
			<text:p text:style-name="P2">Elenco studenti</text:p>
			<text:p text:style-name="P2"><xsl:value-of select="bezeichnung" /></text:p>
			<text:p text:style-name="P3">Semestre: <xsl:value-of select="studiensemester" /></text:p>
			<text:p text:style-name="P2"/>
			<text:p text:style-name="P2">Mese ___________</text:p>
			<text:p text:style-name="P2"/>
			<table:table table:name="Tabelle1" table:style-name="Tabelle1">
				...
				<table:table-row table:style-name="Tabelle1.1">
					<table:table-cell table:style-name="Tabelle1.A3" table:number-columns-spanned="9" office:value-type="string">
						<text:p text:style-name="P13">Insegnante</text:p>
					</table:table-cell>
					<table:covered-table-cell/>
					<table:covered-table-cell/>
					<table:covered-table-cell/>
				...
				<table:table-row table:style-name="Tabelle1.1">
					<table:table-cell table:style-name="Tabelle1.A3" table:number-columns-spanned="9" office:value-type="string">
						<text:p text:style-name="P13"><xsl:value-of select="anzahl_studierende" /> Studenti</text:p>
					</table:table-cell>
					<table:covered-table-cell/>
					<table:covered-table-cell/>
					<table:covered-table-cell/>
